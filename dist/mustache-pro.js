...
var addArrayIndexSupport = (function() {
...
var addFilterSupport = (function() {

    var globalFilters = Mustache.__cache__.filters = {};
    ...
    Mustache.registerFilter = function(obj) {
        extend(globalFilters, obj);
    };

    return addFilterSupport;
